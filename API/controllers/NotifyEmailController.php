...
$app->get('/notifyemail/', function() use ($app) {
	$to = "ronald.lb2@gmail.com";
	$subject = "Quiniela Ronald";
	$headers = "From: quiniela@quinielagalactica.com\r\n";
	$headers .= 'MIME-Version: 1.0' . "\r\n";
	$headers .= "Reply-To: quiniela@quinielagalactica\r\n";
	$headers .= "Return-Path: quiniela@quinielagalactica\r\n";
	$headers .= "CC: quiniela@quinielagalactica\r\n";
	$headers .= "BCC: quiniela@quinielagalactica\r\n";
	$headers .= 'Content-type: text/html; charset=iso-8859-1' . "\r\n";
	$message='<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
	<html xmlns="http://www.w3.org/1999/xhtml">
	<head>
		<meta http-equiv="Content-Type" content="text/html; charset=UTF-8" />
		<title>Quiniela Galactica</title>
		<style type="text/css">
								...
								<table border="0" cellpadding="0" cellspacing="0" width="100%" id="templatePreheader">
									<tr>
										<td valign="top" class="preheaderContent" style="padding-top:10px; padding-right:20px; padding-bottom:10px; padding-left:20px;" mc:edit="preheader_content00">
											Volvio la Quiniela con el Mundial Rusia 2018!
										</td>
										<!-- *|IFNOT:ARCHIVE_PAGE|* -->
								...
								<table border="0" cellpadding="0" cellspacing="0" width="100%" id="templateHeader">
									<tr>
										<td valign="top" class="headerContent">
											<img src="http://res.cloudinary.com/tucano-digital/image/upload/v1528849021/appquiniela/banner_big.jpg" style="max-width:600px;" id="headerImage" mc:label="header_image" mc:edit="header_image" mc:allowdesigner mc:allowtext />
										</td>
									</tr>
								</table>
								<!-- // END HEADER -->
											...
											<table border="0" cellpadding="20" cellspacing="0" width="100%">
												<tr>
													<td valign="top" class="leftColumnContent" mc:edit="left_column_content">
														<h3>Volvio la <a href="http://www.quinielagalactica.com">Quiniela Galactica</a></h3>
														<br />
														<h3>Descargala para android desde <a href="https://play.google.com/store/apps/details?id=com.quinielagalactica.echo">Quiniela Galactica</a>
															<br />Ya estamos listos para el Mundial Rusia 2018
															<br /> No te quedes fuera.
														</td>
													</tr>
												</table>
											</td>
									...
									<table border="0" cellpadding="0" cellspacing="0" width="100%" id="templateFooter">
										...
										<tr>
											<td valign="top" class="footerContent" style="padding-top:0;" mc:edit="footer_content01">
												...
												<br />
												contacto@quinielagalactica.com
											</td>
										</tr>
									</table>
									<!-- // END FOOTER -->
